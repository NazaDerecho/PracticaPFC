...
carpeta_principal = Path(
    r"C:\Users\lourd\OneDrive\Escritorio\Naza\PFC\Caso 2\Stress_dataset\15"
)
...
for carpeta_sujeto in carpetas_sujetos:
    ...
    for senal in senales:
        ...
        try:
            ...
            # ------------------------------------------------
            # IBI tiene estructura diferente
            # ------------------------------------------------
